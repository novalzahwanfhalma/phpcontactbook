...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <input type="text" id="name" name="name" placeholder="Contact's full name"
                value="<?php if(isset($_GET['edit'])) echo $editedContact['name']; ?>" required><br>
            <label for="phone">Phone:</label><br>
            <input type="text" id="phone" name="phone" placeholder="Contact's phone number"
                value="<?php if(isset($_GET['edit'])) echo $editedContact['phone']; ?>" required><br>
            <label for="email">Email:</label><br>
            <input type="email" id="email" name="email" placeholder="Contact's email address"
                value="<?php if(isset($_GET['edit'])) echo $editedContact['email']; ?>" required><br><br>
